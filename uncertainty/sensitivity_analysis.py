...
age2014 = pd.read_excel(r'.\data\allocation_data\Allocation_2014-2017.xlsx', sheet_name = 7, usecols='A:K') # 2014
...
k = 12 # change this number for 13 differnt injuries
split.iloc[k,1] = split.iloc[k,1] + 0.01
split.iloc[k,2] = split.iloc[k,2] - 0.01
